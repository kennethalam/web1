        ...
        <div className="flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 animate-fade-in-left">
            <div className="inline-flex items-center bg-white/5 backdrop-blur-sm border border-white/10 rounded-full px-4 py-1.5 mb-6">
              <span className="text-xs font-medium text-crypto-purple mr-2"><a href="https://discord.gg/JAZgWBxBr7">Contactanos en</a></span>
              <span className="text-xs text-gray-300"><a href="https://discord.gg/JAZgWBxBr7">Discord</a></span>
              <ChevronRight className="h-4 w-4 text-gray-400 ml-1" />
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
             Soluciones de hospedaje para tu <span className='text-gradient'>Comunidad</span>
            </h1>
            <p className="text-lg text-gray-300 mb-8 max-w-lg">
              Ofrecemos lo mejor en rendimiento y precios asequibles, ya es hora de un cambio.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="bg-crypto-purple hover:bg-crypto-dark-purple text-white px-8 py-6">
                <a href="https://billing.trustsnodes.com/store">Comprar Ahora</a>
            ...
            <div className="relative max-w-md mx-auto animate-float">
              ...
              <div className="absolute -right-6 -bottom-6 bg-crypto-purple/20 backdrop-blur-md rounded-lg p-4 border border-crypto-purple/30 shadow-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-green-500">93.75%</p>
                  </div>
                </div>
              </div>
              <div className="absolute -left-6 -top-6 bg-crypto-purple/20 backdrop-blur-md rounded-lg p-4 border border-crypto-purple/30 shadow-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-xs text-gray-400">DDoS Security</p>
                    <p className="text-lg font-bold text-white">Datapacket</p>
                  </div>
                </div>
              </div>
            </div>
