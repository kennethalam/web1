  ...
  return (
    <>
      ...
      <div className="bg-[#0B0C16] text-gray-400 min-h-screen py-20">
        ...
        {/* ✅ Botón menú móvil movido un poco más abajo */}
        <div className="lg:hidden flex justify-end px-6 mb-5 mt-6">
          <button
            onClick={() => setMenuOpen(!menuOpen)}
            className="bg-[#12141C] border border-[#1f2033] rounded-xl px-4 py-2 text-sm text-white"
          >
        ...
        <div className="container mx-auto px-6 flex flex-col lg:flex-row gap-10 text-[15px] leading-relaxed">
          ...
          {/* SIDEBAR */}
          <aside
            className={`lg:w-1/4 bg-[#12141C] rounded-2xl p-5 h-max lg:sticky top-24 shadow-lg border border-[#1f2033] text-sm transition-all duration-300 ${
          ...
          <main className="lg:w-3/4 bg-[#12141C] rounded-2xl p-8 shadow-lg border border-[#1f2033] space-y-14 text-[15px]">
            ...
            <p className="text-xs text-gray-500 mb-8">
              Última actualización: <span className="text-[#a36cff]">26 de octubre de 2025</span>
            </p>
...
function contenidoSeccion(id: string): string {
  switch (id) {
    case "1":
      return "Al acceder o utilizar los servicios de TrustsNodes, el usuario acepta estos términos. Este acuerdo constituye un contrato legalmente vinculante entre el cliente y TrustsNodes.";    default:
      return "Contenido de sección...";
      case "2":
